...
public class AutoGeneratedProcessor extends AnnotationProcessorSupport {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (final TypeElement typeElement : types) {
            ...
            if (!autoGenerated.value().equals(AUTO_ASYNC_PROCESSOR_VALUE) ||
            ...
            try {
                ...
                for (Element enclosed : typeElement.getEnclosedElements()) {
                    if (enclosed.getKind() == ElementKind.METHOD) {
                        ...
                        methodSpecs.add(processExecutableElement(executableElement, false));
                    }
                }
                TypeSpec facade = TypeSpec.classBuilder(FACADE_PREFIX + getSimpleTypeName(typeElement))
                        ...
                        .addAnnotation(AnnotationSpec.get(new AutoGenerated() {
                            ...
                            @Override
                            public String value() {
                                return AUTO_GENERATED_PROCESSOR_VALUE;
                            }
